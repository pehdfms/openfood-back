...
export class Migration20230401004552 extends Migration {
  ...
  async down(): Promise<void> {
    this.addSql('alter table "product" alter column "serving_quantity" type int using ("serving_quantity"::int);');
    this.addSql('alter table "product" alter column "nutriscore_score" type int using ("nutriscore_score"::int);');
  }
